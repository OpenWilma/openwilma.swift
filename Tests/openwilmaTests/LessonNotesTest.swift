...
class LessonNotesTest: XCTestCase {
    ...
    func testLessonNoteParser() async throws {
        ...
        print(notes.first?.noteStart, notes.first?.noteEnd, DateUtils.standardGMT.date(from: "2018-02-27 07:00:00"), DateUtils.standardGMT.date(from: "2018-02-27 07:45:00"))
        XCTAssert(notes.first?.noteStart == DateUtils.standardGMT.date(from: "2018-02-27 07:00:00"))
        XCTAssert(notes.first?.noteEnd == DateUtils.standardGMT.date(from: "2018-02-27 07:45:00"))
